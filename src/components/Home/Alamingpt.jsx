...
const Alamingpt = () => {
  ...
  className="flex flex-col items-center justify-center h-screen
             bg-gradient-to-br from-[#2e1a12] via-[#402010] to-[#2e1a12]
             text-white px-4"
>
  {/* --- title --- */}
  <h1
  ...
  >
    ...
    <textarea
      ...
      className="w-full h-40 resize-none
                 bg-transparent text-white placeholder:text-amber-300
    ...
    {answer && (
      <div
        className="relative max-h-60 overflow-y-auto p-5 text-white text-base leading-relaxed
         ...
         before:rounded-2xl
         before:bg-gradient-to-br before:from-transparent before:via-orange-300/20 before:to-transparent
         scrollbar-thin scrollbar-thumb-orange-400/50 scrollbar-track-transparent"
      >
        {answer}
      </div>
    )}
